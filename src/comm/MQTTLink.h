...
//#define MQTTLINK_READWRITE_DEBUG   // Use to debug data reads/writes

#define QGC_MQTT_PORT 8883
...
public:
    ...
    LinkType    type            () { return LinkConfiguration::TypeMQTT; }
    void        copyFrom        (LinkConfiguration* source);
    bool        isHighLatencyAllowed () { return true; }
    void        loadSettings    (QSettings& settings, const QString& root);
    void        saveSettings    (QSettings& settings, const QString& root);
    void        updateSettings  ();
    QString     settingsURL     () { return "MQTTSettings.qml"; }
...
class MQTTLink : public LinkInterface
{
    ...
    friend class MQTTLinkTest;
    friend class MQTTConfiguration;
...
private:
    ...
    MQTTLink(SharedLinkConfigurationPointer& config);
    ~MQTTLink();
